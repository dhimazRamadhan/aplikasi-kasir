                    ...
                    <CCard className="" style={{height: '200px'}} >
                        <CCardBody>    
                            <CCol className='d-flex align-items-center justify-content-center mt-5'>
                                <CRow md="8">
                                    <div> 
                                        <h2 className="card-title mb-0">Selamat Datang {this.state.user.nama} !</h2>
                                        <div className=" text-medium-emphasis mb-5 text-capitalize align-middle">Anda berhasil login sebagai {this.state.user.role}</div>
                                    </div> 
                                </CRow>
                            </CCol>                                            
                        </CCardBody>
